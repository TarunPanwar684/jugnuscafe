    ...
    <section id="location" className="py-24 bg-brand-dark relative z-20">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div>
              <h2 className="text-4xl md:text-5xl font-serif text-brand-gold mb-4">Visit Us</h2>
              <div className="h-1 w-16 bg-brand-saffron rounded-full"></div>
            </div>

            <p className="text-brand-cream/70 text-lg">
              Come experience the vibrance of authentic Indian cuisine. We are looking forward to serving you!
            </p>
            ...
            >
              <motion.li variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} className="flex items-start gap-4 text-brand-cream/90 group">
                ...
                <div>
                  ...
                  <p className="text-xl mt-1">8:00 AM - 10:00 PM</p>
                  <p className="text-sm text-brand-cream/60">Open Seven Days a Week</p>
                </div>
              </motion.li>
              <motion.li variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} className="flex items-start gap-4 text-brand-cream/90 group">
                <div className="mt-1 text-brand-saffron bg-brand-saffron/10 p-3 rounded-full group-hover:bg-brand-saffron group-hover:text-brand-dark transition-all shadow-[0_0_15px_rgba(245,158,11,0.1)] group-hover:shadow-[0_0_25px_rgba(245,158,11,0.4)]">
                ...
                <div>
                  ...
                  <p>Ch. Hukum Singh Market, Near Gupta Furniture,<br/>Islamnagar Road, Rampur Maniharan,<br/>Saharanpur, Uttar Pradesh – 247451</p>
              ...
              <motion.li variants={{ hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0 } }} className="flex items-start gap-4 text-brand-cream/90 group">
                ...
                <div>
                  ...
                  <a href="https://wa.me/918218524305?text=Hello%2C%20I%20want%20to%20order%20from%20Chauhan%27s%20Sweets%20and%20Restaurant" target="_blank" rel="noopener noreferrer" className="hover:text-[#25D366] transition-colors block text-xl">Message on WhatsApp</a>
                </div>
              </motion.li>
